...
* Go to the Gogs url in you browser: http://gogs-lab-infra.apps.berlin-618f.openshiftworkshop.com[http://gogs-lab-infra.apps.berlin-618f.openshiftworkshop.com^]
...
* Go back to Che : http://che-lab-infra.apps.berlin-618f.openshiftworkshop.com[http://che-lab-infra.apps.berlin-618f.openshiftworkshop.com^]
* Log in (if required) 
** Username : <GUID>
** Password : <The standard password provided>
...
=== Task: Make your robot stop at a certain point before an obstacle
