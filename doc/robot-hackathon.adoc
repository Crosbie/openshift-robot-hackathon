...
robot. Just remember to fill in `*<GUID>*` when you test.  
...
----
http://codeready-workspaces.apps.berlin-<CHANGEME>.openshiftworkshop.com
----
...
** Choose *GIT*
** *URL*: http://gogs-lab-infra.apps.city-guid.openshiftworkshop.com
