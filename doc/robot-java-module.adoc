...
* Go back to the Gogs url in you browser: http://gogs-lab-infra.apps.43d7.events.opentlc.com[Gogs^]
...
* Go back to Che : hhttp://che-lab-infra.apps.43d7.events.opentlc.com[Che^]
* Log in (if required) 
** Username : <GUID>
** Password : <The standard password provided>
...
** Choose *GIT*
** *URL of your Git repo*: http://gogs-lab-infra.apps.43d7.events.opentlc.com/<GUID>/<GUID>-app.git
** *Name*: 
